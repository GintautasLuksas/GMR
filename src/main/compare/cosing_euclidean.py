...
for watched_index, watched_movie in watched_clusters_df.iterrows():
    ...
    watched_cluster = watched_movie["KMeans Cluster"]

    # Filter movies from the same KMeans cluster
    same_cluster_movies = clusters_df[clusters_df["KMeans Cluster"] == watched_cluster]
    ...
    if genre_match:
        ...
        comparison_entry = {
            ...
            "KMeans Cluster": watched_cluster,
...
# Print results
print("Final Recommendations Based on KMeans Cluster Filtering:")
