...
def recommend_movies():
    """Reads two CSV files containing movie cluster data, calculates cosine similarity and Euclidean distances between the movie embeddings, and generates a recommendation based on a weighted combination of these scores."""
    ...
    columns_to_show = [
        ...
        "Metascore", "Short Description", "Directors", "Star 1", "Star 2", "Star 3","Genre 1","Genre 2","Genre 3",
