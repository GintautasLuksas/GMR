...
nn_cluster_labels.to_csv(r'C:\Users\user\PycharmProjects\GMR\src\main\compare_embeded\nn_cluster2.csv', index=False)
...
nn_with_cluster.to_csv(r'C:\Users\user\PycharmProjects\GMR\src\system_test_data\random_forest\embeded_with_cluster.csv', index=False)
