...
df = pd.DataFrame({
    ...
    'Length (minutes)': [random.randint(80, 150) for _ in range(100)],
    'Rating Amount': [random.randint(10000, 1000000) for _ in range(100)],
    'Metascore': [round(random.uniform(50.0, 100.0), 1) for _ in range(100)],
